...
namespace previrt
{
  ...
  struct CGcounter
  {
    ...
    const unsigned int BasicBlock;
    unsigned int Instructions;
    unsigned int Callers;
    unsigned int Callees;

    CGcounter(std::string func, unsigned int bb, unsigned int inst, unsigned int callers, unsigned int callee) : FunctionName(func), BasicBlock(bb), Instructions(inst), Callers(callers), Callees(callee) {}
  };
                       ...
                       public llvm::InstVisitor<ProfilerPass>
  {
    ...
    // -- CG counters
    std::vector<CGcounter> functions;
    ...
    void formatCounters(std::vector<Counter> &counters,
                        ...
                        bool sort = true);
    void formatCountersCG(std::vector<CGcounter> &counters,
                          unsigned &MaxNameLen, unsigned &MaxValLen);
    void incrInstCounter(std::string name, unsigned val);
    void visitFunction(llvm::Function &F);
    void visitBasicBlock(llvm::BasicBlock &BB);
    void visitCallSite(llvm::CallBase CS);
  ...
  public:
    ...
    void printCountersCSV(llvm::Module &M);
  };
