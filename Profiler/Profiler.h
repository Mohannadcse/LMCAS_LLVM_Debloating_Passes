...
namespace previrt {
  ...
  struct CGcounter {
    ...
    CGcounter(std::string func, unsigned int bb, unsigned int inst, unsigned int callers, unsigned int callee):
    	FunctionName(func), BasicBlock(bb), Instructions(inst), Callers(callers), Callees(callee) {}
  };
